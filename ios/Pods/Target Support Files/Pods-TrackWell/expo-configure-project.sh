...
with_node \
  ...
  --target "/Users/rentamac/Documents/NapHab/ios/Pods/Target Support Files/Pods-TrackWell/ExpoModulesProvider.swift" \
  --entitlement "/Users/rentamac/Documents/NapHab/ios/TrackWell/TrackWell.entitlements" \
   \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-notifications" "expo-splash-screen"
